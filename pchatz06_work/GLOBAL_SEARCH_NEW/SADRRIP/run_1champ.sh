...
setenv RESULTS /home/pchatz06/RRIP_work/pchatz06_work/GLOBAL_SEARCH/SADRRIP/Results
setenv SCRIPTS /home/pchatz06/RRIP_work/pchatz06_work/GLOBAL_SEARCH/SADRRIP
...
# Validation - pchatz06
echo "./bin/$binary -warmup_instructions ${n_warm}000000 -simulation_instructions ${n_sim}000000 -rrip_policies $option -dirty_rrip_policies $d_option -psel_width $pso -psel_mask $mask -hit_mask $hit -dsalgo $dsalgo -window_size $window -sr_thr $srt -br_thr $brt -boost $boost -demote_mask $dem -traces ${TRACE_DIR}${trace}.trace.gz >& $outp"
